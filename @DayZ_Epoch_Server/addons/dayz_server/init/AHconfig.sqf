...
/*  SUPER ADMIN HERE      */ _SAdmins = []; //do not have a , at the end. 
/*  BANNED PLAYER HERE    */ _BLOCKED = []; //do not have a , at the end.
/* ********************************************************************************* */
/*  Top esc menu TXT      */ _TopOfESC = "Сервер: #1 Ultima"; //do not use " in this text.
/*  Bottom esc menu TXT   */ _LowerTop = "Адрес сайта:"; //do not use " in this text.
/*  Bottom esc menu TXT2  */ _LowerBottom = "rnrportal.ru"; //do not use " in this text.
/*  Color esc menu TXT    */ _EscColor = [0.6,0,0,1];
/*  DebugMonitor TXT      */ _BottomDebug = "rnrportal.ru"; //do not use " in this text.
...
/*  Удалить "itemsAdded"   */ _RAI =  false;	/* true or false */	/* recommended:  true */	/* может удалять элементы из системы пользовательского крафт .. */
...
/*  Remove Keybinds ?     */ _RCK =  false;	/* true or false */	/* recommended:  true */	/* Удаляет Польз.кнопки связывает и отодвигает конфигурации по умолчанию */
...
/*  ALLOWED Dialogs       */ _ALLOWED_Dialogs = [-1,106,2200,6900,6901,6902,6903,420420,41144,23000,51000,24000,10000,20000,13000,19000,11000,14000,15000,18000,16000,17000,22000,21000];
...
[
	...
	"s_player_lockunlock","s_vehicle_lockunlock","s_player_toggleSnap","s_player_toggleSnapSelect","s_player_toggleSnapSelectPoint","mv22_fold","mv22_unfold","mv22_open","mv22_close","suv_close","suv_open"
];
/* ********************************************************************************* */
/* *******************Developer : infiSTAR (infiSTAR23@gmail.com)******************* */
/* ******************Copyright © 2014 infiSTAR all rights reserved****************** */
