private ["_guaranteedLoot","_randomizedLoot","_spawnChance","_spawnMarker","_spawnRadius","_crashModel","_lootTable","_spawnRoll","_position","_crash","_num","_itemTypes","_index1","_index2","_weights","_cntWeights","_nearby","_itemType","_needsrelocated","_istoomany"];
_guaranteedLoot	=	4;
_randomizedLoot	=	8;
_spawnChance		=	0.50;
_spawnMarker		=	'center';
