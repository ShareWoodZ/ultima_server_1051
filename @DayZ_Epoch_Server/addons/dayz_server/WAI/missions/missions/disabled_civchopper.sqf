...
"Villager1",						  // Одежда. "" для случайного выбора. Или вписать имя класса.
...
[nil,nil,rTitleText,"Вооруженная гопота захватила гражданский вертолет! Метка нанесена на карту...", "PLAIN",10] call RE;
...
if (_playerPresent) then {
	...
	[nil,nil,rTitleText,"Выжившие отбили вертолет у гопников!", "PLAIN",10] call RE;
} else {
	...
	[nil,nil,rTitleText,"Гопота сумела угнать вертолет, выжившие опоздали!", "PLAIN",10] call RE;
};
