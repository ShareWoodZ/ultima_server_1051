...
[[_position select 0, _position select 1, 0],3,1,"Random",4,"","TK_INS_Soldier_AT_EP1","Random",true] call spawn_group;
...
//Turrets
[[[(_position select 0) - 10, (_position select 1) + 10, 0]],"Stinger_Pod_US_EP1",1,"TK_INS_Soldier_AT_EP1",1,2,"","Random",true] call spawn_static;
[[[(_position select 0) + 10, (_position select 1) - 10, 0]],"Stinger_Pod_US_EP1",1,"TK_INS_Soldier_AT_EP1",1,2,"","Random",true] call spawn_static;
[[[(_position select 0) + 20, (_position select 1) + 20, 0]],"ZU23_TK_EP1",1,"TK_INS_Soldier_AT_EP1",1,2,"","Random",true] call spawn_static;
[[[(_position select 0) - 30, (_position select 1) - 30, 0]],"ZU23_TK_EP1",1,"TK_INS_Soldier_AT_EP1",1,2,"","Random",true] call spawn_static;
...
[_position,"База бандитов"] execVM "\z\addons\dayz_server\WAI\missions\compile\markers.sqf";
[nil,nil,rTitleText,"Группа бандитов устроила лагерную стоянку! Устройте им засаду, чтобы забрать все что у них есть!!", "PLAIN",10] call RE;
...
if (_playerPresent) then {
	...
	[nil,nil,rTitleText,"Выжившие захватили лагерь бандитов!!", "PLAIN",10] call RE;
} else {
	...
	[nil,nil,rTitleText,"Бандиты свернули лагерную стоянку..", "PLAIN",10] call RE;
};
