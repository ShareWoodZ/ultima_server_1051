...
// RIFLES
_box addWeaponCargoGlobal ["G36C", 3];
_box addWeaponCargoGlobal ["M4A1_AIM_CAMO", 3];
_box addWeaponCargoGlobal ["RPK_74", 3];
_box addWeaponCargoGlobal ["M4A1_AIM_SD_camo", 3];
...
_box addMagazineCargoGlobal ["30Rnd_556x45_StanagSD", 5];
