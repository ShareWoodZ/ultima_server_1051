...
DZAI_vehList = [["UAZ_Unarmed_TK_EP1",10]];
...
//AI skill settings level 0 (Skill, Minimum skill, Maximum skill). Baseline skill level: 0.70
DZAI_skill0 = [	
	["aimingAccuracy",0.5,0.5],
	["aimingShake",0.6,0.6],
	["aimingSpeed",0.6,0.6],
	["endurance",0.6,0.6],
	["spotDistance",0.6,0.6],
	["spotTime",0.6,0.6],
	["courage",0.6,0.6],
	["reloadSpeed",0.6,0.6],
	["commanding",0.6,0.6],
...
//AI skill settings level 1 (Skill, Minimum skill, Maximum skill). Baseline skill level: 0.80
DZAI_skill1 = [	
	["aimingAccuracy",0.6,0.6],
	["aimingShake",0.7,0.7],
	["aimingSpeed",0.7,0.7],
	["endurance",0.7,0.7],
	["spotDistance",0.7,0.7],
	["spotTime",0.7,0.7],
	["courage",0.7,0.7],
	["reloadSpeed",0.7,0.7],
	["commanding",0.7,0.7],
...
//AI skill settings level 2 (Skill, Minimum skill, Maximum skill). Baseline skill level: 0.90
DZAI_skill2 = [	
	["aimingAccuracy",0.7,0.7],
	["aimingShake",0.8,0.8],
	["aimingSpeed",0.8,0.8],
	["endurance",0.8,0.8],
	["spotDistance",0.8,0.8],
	["spotTime",0.8,0.8],
	["courage",0.8,0.8],
	["reloadSpeed",0.8,0.8],
	["commanding",0.8,0.8],
...
//AI skill settings level 3 (Skill, Minimum skill, Maximum skill). Baseline skill level: 1
DZAI_skill3 = [	
	["aimingAccuracy",0.8,0.8],
	["aimingShake",0.9,0.9],
	["aimingSpeed",0.9,0.9],
	["endurance",0.9,0.9],
	["spotDistance",0.9,0.9],
	["spotTime",0.9,0.9],
	["courage",0.9,0.9],
	["reloadSpeed",0.9,0.9],
	["commanding",0.9,0.9],
...
DZAI_Pistols4 = ["M9SD","MakarovSD"]; //Weapongrade 4 pistols

DZAI_Rifles0 = ["LeeEnfield","Winchester1866","MR43","huntingrifle","LeeEnfield","Winchester1866","MR43"]; //Weapongrade 0 rifles
DZAI_Rifles1 = ["M16A2","M16A2GL","AK_74","M4A1_Aim","AKS_74_kobra","AKS_74_U","AK_47_M","M24","M1014","M4A1","M14_EP1","Remington870_lamp","MP5A5","MP5SD","M4A3_CCO_EP1"]; //Weapongrade 1 rifles
DZAI_Rifles2 = ["M16A2","M16A2GL","M249_DZ","AK_74","M4A1_Aim","AKS_74_kobra","AKS_74_U","AK_47_M","M24","SVD_CAMO","M1014","M4A1","M14_EP1","Remington870_lamp","M240_DZ","M4A1_AIM_SD_camo","M16A4_ACG","M4A1_HWS_GL_camo","Mk_48_DZ","M4A3_CCO_EP1","Sa58V_RCO_EP1","Sa58V_CCO_EP1","M40A3","Sa58P_EP1","Sa58V_EP1"]; //Weapongrade 2 rifles
DZAI_Rifles3 = ["Mk_48_DZ","M249_DZ","G36C","G36C_camo","G36A_camo","G36K_camo","AK_47_M","AKS_74_U","M14_EP1","bizon_silenced","RPK_74"]; //Weapongrade 3 rifles
DZAI_Rifles4 = ["Mk_48_DZ","M249_DZ"]; //Weapongrade 4 rifles
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
DZAI_BanditTypes = ["TK_INS_Soldier_EP1_DZ","TK_INS_Warlord_EP1_DZ"];
...
DZAI_Medicals1 = ["ItemPainkiller","ItemEpinephrine"];
DZAI_Medicals2 = ["ItemPainkiller","ItemBloodbag", "ItemAntibiotic","ItemEpinephrine"];
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
DZAI_tools0 = [["ItemFlashlight",0.65],["ItemWatch",0.65],["ItemKnife",0.50],["ItemHatchet",0.40],["ItemCompass",0.40],["ItemMap",0.35],["ItemToolbox",0.15],["ItemMatchbox",0.15],["ItemFlashlightRed",0.05],["ItemGPS",0.005],["ItemCrowbar",0.15]];
DZAI_tools1 = [["ItemFlashlight",0.75],["ItemWatch",0.75],["ItemKnife",0.75],["ItemHatchet",0.70],["ItemCompass",0.75],["ItemMap",0.70],["ItemToolbox",0.35],["ItemMatchbox",0.40],["ItemFlashlightRed",0.10],["ItemGPS",0.10],["ItemCrowbar",0.35]];
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
DZAI_gadgets0 = [["binocular",0.40],["NVGoggles",0.01]];
