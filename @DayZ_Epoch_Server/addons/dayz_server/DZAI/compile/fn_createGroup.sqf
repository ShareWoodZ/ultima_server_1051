...
//скины от уровня навыков
if(_weapongrade > 3) then 
{
DZAI_Bandit_DC = ["CZ_Soldier_DES_EP1","CZ_Soldier_DES_EP1"];	
}	
else
{
DZAI_Bandit_DC = DZAI_BanditTypes;
};
for "_i" from 1 to _totalAI do {
	private ["_type","_unit"];
	_type = DZAI_Bandit_DC call BIS_fnc_selectRandom2;								// Select skin of AI unit
