...
_missName	=	"Миссия Урал. Засада.";
_coords		=	call DZMSFindPos;
[nil,nil,rTitleText,"Преступники устроили засаду у урала с припасами!", "PLAIN",10] call RE;
...
[nil,nil,rTitleText,"Урал с припасами перешел под контроль выживших!", "PLAIN",6] call RE;
diag_log format["[DZMS]: Мажор миссия SM5 завершена."];
