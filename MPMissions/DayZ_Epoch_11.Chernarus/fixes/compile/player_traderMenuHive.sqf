...
TraderDialogLoadItemList	=
	{
		...
		lbAdd [TraderDialogItemList, "Загружается список предметов..."];
		...
		_item_list = [];
		{
			private ["_bax_in","_bax_out","_header", "_item", "_name", "_type", "_textPart", "_qty", "_buy", "_bqty", "_bname", "_btype", "_btextCurrency", "_sell", "_sqty", "_sname", "_stype", "_stextCurrency", "_order", "_order", "_afile", "_File", "_count", "_bag", "_bagclass", "_index", "_image"];
			_header	=	_x select 0;
			_item	=	_x select 1;
			...
			_item_list set [count _item_list,[_name,_textPart,_bax_in,_bname,"Баксы",_bax_out,_sname,"Баксы",_header,_File]];
