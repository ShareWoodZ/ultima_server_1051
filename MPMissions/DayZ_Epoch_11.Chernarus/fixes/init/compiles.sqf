...
if (!isDedicated) then {
	...
	fnc_usec_damageActions =		compile preprocessFileLineNumbers "fixes\compile\fn_damageActions.sqf";		//Checks which actions for nearby casualty
	fnc_inAngleSector =				compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\fn_inAngleSector.sqf";		//Checks which actions for nearby casualty
	fnc_usec_selfActions =			compile preprocessFileLineNumbers "fixes\compile\fn_selfActions.sqf";		//Checks which actions for self
	...
	player_unlockDoor =			compile preprocessFileLineNumbers "fixes\compile\player_unlockDoor.sqf";
	...
	player_death =				compile preprocessFileLineNumbers "fixes\compile\player_death.sqf";
	player_switchModel =		compile preprocessFileLineNumbers "fixes\compile\player_switchModel.sqf";
	...
	player_build =				compile preprocessFileLineNumbers "fixes\actions\player_build.sqf";
	...
	if (DZE_ConfigTrader) then {
		call compile preprocessFileLineNumbers "fixes\compile\player_traderMenuConfig.sqf";
	}else{
		call compile preprocessFileLineNumbers "fixes\compile\player_traderMenuHive.sqf";
	};
	// recent murders menu code
	call compile preprocessFileLineNumbers "fixes\compile\player_murderMenu.sqf";
	...
	[] spawn {
        ...
        while { _timeOut < 12000 } do {
            if (dayz_clientPreload && dayz_authed) exitWith
				{
					diag_log "[Клиент]: [Логин]: Процедура логина завершена!";
					endLoadingScreen;
				};
            if (!isNil "_display") then {
	...
	fnc_usec_damageHandler =		compile preprocessFileLineNumbers "fixes\compile\fn_damageHandler.sqf";		//Event handler run on damage
	fnc_veh_ResetEH = 			compile preprocessFileLineNumbers "\z\addons\dayz_code\init\veh_ResetEH.sqf";			//Initialize vehicle
	// Vehicle damage fix
	vehicle_handleDamage    = 		compile preprocessFileLineNumbers "fixes\compile\vehicle_handleDamage.sqf";
	...
	local_lockUnlock =			compile preprocessFileLineNumbers "fixes\compile\local_lockUnlock.sqf";		//When vehicle is local to unit perform locking vehicle
	...
	local_eventKill = 			compile preprocessFileLineNumbers "fixes\compile\local_eventKill.sqf";		//Generated when something is killed
